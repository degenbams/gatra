...
export function DeleteIncomeButton({ incomeId }: { incomeId: string }) {
  ...
  async function handleDelete() {
    ...
    const confirmed = window.confirm("Hapus pemasukan tambahan ini?");
    ...
    if (deleteError) {
      setError("Pemasukan belum berhasil dihapus.");
      return;
    }
